...
class SpectrumView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        def tool(text, tip, slot=None, checkable=False):
            b = QToolButton()
            b.setText(text)
            b.setToolTip(tip)
            b.setAutoRaise(True)
            ...
            row.addWidget(b)
            return b
        self.auto_btn = tool("Auto", "Back to automatic axis ranges (they stay fixed once you zoom or pan)", self.reset_view)
        row.addWidget(QLabel("y:"))
        self.zmin_edit = QLineEdit("0.0")
        self.zmin_edit.setMaximumWidth(60)
        self.zmin_edit.setToolTip("Lower flux limit (used when the scale is fixed)")
        ...
        self.zmax_edit.setMaximumWidth(60)
        self.zmax_edit.setToolTip("Upper flux limit (used when the scale is fixed)")
        ...
        self.mode_combo.setToolTip("How the spectrum of a mask is extracted")
