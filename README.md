...
pip install -e ".[gui]"     # plus PyQt6 and pyqtgraph for the GUI
...
kubeviz                       # file dialog
kubeviz session.kvz           # reopen a saved session
```
...
0 = all cores but one, at most 8), also adjustable in the fit Options.
